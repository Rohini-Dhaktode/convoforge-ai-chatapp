...
const SidebarComp = () => {
  ...
  return (
    <div
      className="flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col text-sm">
          ...
          <p className="text-xs text-gray-400">
            Purchase credits to use convoforge-ai-chat
          </p>
        </div>
      </div>
      ...
      <div
        ...
        dark:border-white/15 rounded-md  transition-all"
      >
